<template>
  <div>
    ...
    <el-card>
      <!-- 警示文案 -->
      <el-alert title="注意：只能为第三级分类设置相关参数"
                type="warning"
                show-icon
                :closable="false">
      </el-alert>
...
export default {
  ...
  methods: {
    ...
    showInput (row) {
      ...
      // 让文本框自动获得焦点
      // .$nextTick当页面元素被重新渲染之后 才会指定回调函数中的代码
      this.$nextTick(_ => {
